...
- {Nyear}-03-01: null
  """
    agromanagement = yaml.safe_load(agro_rice.format(year=year,Nyear=year+1,crop='rice'))
...
def Initial(data_dir, Start_time, dco2, ds):
    ...
    crop_data.set_active_crop('rice', 'Rice_IR72_WS')
...
if __name__ == '__main__':
    ...
    for ssp in ssps:
        ...
        dk.to_netcdf('%s/rice_output_%s_%s.nc' % (fname,ssp,runname), engine='netcdf4')
