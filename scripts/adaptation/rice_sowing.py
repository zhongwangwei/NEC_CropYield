...
- {Nyear}-03-01: null
  """
    agromanagement = yaml.safe_load(agro_rice.format(year=year, Nyear=year + 1, crop='rice', startdate=start))
...
if __name__ == '__main__':
    ...
    for ssp in ssps:
        ...
        for i in np.arange(63,147,7):
            ...
            dk.to_netcdf('%s/rice_output_%s_%s_%s.nc' % (fname, ssp, runname,i), engine='netcdf4')
