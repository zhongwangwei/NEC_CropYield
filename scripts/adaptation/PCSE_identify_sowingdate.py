    ...
    for scenario in scenarios:
        for name,idx,colr in zip(names,idxs,colors):
            for ssp in ssps:
                ...
                lons= xr.open_dataset('/tera04/zhwei/PCSE/data/pr_t/pr_t_Growthday_ssp585.nc').lon.values
                lats= xr.open_dataset('/tera04/zhwei/PCSE/data/pr_t/pr_t_Growthday_ssp585.nc').lat.values
                #fixtime=Start_time*0+105
                ds1= xr.open_dataset(f'/tera04/zhwei/PCSE/data/output/sensitivity/default/{name}_output_{ssp}_default.nc')
                ...
                ds5 = xr.open_dataset(f'/tera04/zhwei/PCSE/data/pr_t/pr_t_Growthday_{ssp}.nc')
