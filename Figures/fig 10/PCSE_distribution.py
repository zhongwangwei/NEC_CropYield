...
def plot_trend(VarFile, figout, ssp, scenario):
    ...
    for i, year in enumerate(ds.year):
        ...
        plt.savefig('%s/crop_distribution/crop_distribution_%s.eps' % (figout, year.values), format='eps', dpi=800)
        plt.savefig('%s/crop_distribution/crop_distribution_%s.png' % (figout, year.values), format='png', dpi=800)
        plt.show()
        plt.close()
...
if __name__ == '__main__':
    ...
    figout = "C:/Users/Administrator/Desktop/PCSE/fig 10/"
    VarFile = "C:/Users/Administrator/Desktop/PCSE/fig 9/optimized_distribution.nc"
    print('plotting now')
    scenario = 'strategy'
    ssp = 'ssp585'
